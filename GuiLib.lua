...
local objects = {}
local themes = {
    Background = Color3.fromRGB(34, 33, 39),
    Glow = Color3.fromRGB(34, 33, 39),
    Accent = Color3.fromRGB(24, 23, 28),
    LightContrast = Color3.fromRGB(28, 27, 32),
    DarkContrast = Color3.fromRGB(19, 18, 23),  
