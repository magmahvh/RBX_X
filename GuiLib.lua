...
do
    ...
    function utility:Tween(instance, properties, duration, name_)
        tween:Create(instance, tweeninfo(duration, name_), properties):Play()
    end
...
do
    ...
    function library:addPage(name_)
        local page = page.new(self, name_)
    ...
    function page:addSection(name_)
        local section = section.new(self, name_)
        ...
        button.MouseButton1Click:Connect(
            function()
                ...
                if callback then
                    callback(
                        function(name_)
                            self:updateButton(button, name_)
                        end
                    )
                end
            ...
            function()
                ...
                if callback then
                    callback(
                        active,
                        function(name_)
                            self:updateToggle(toggle, name_)
                        end
                    )
                end
            end
            ...
            function()
                ...
                if callback then
                    callback(
                        ...
                        nil,
                        function(name_)
                            self:updateTextbox(textbox, name_)
                        end
                    )
                end
            end
        ...
        self.binds[keybind] = {
            callback = function()
                ...
                if callback then
                    callback(
                        function(name_)
                            self:updateKeybind(keybind, name_)
                        end
                    )
                end
            end
        ...
        local callback = function(value)
            if callback then
                callback(
                    value,
                    function(name_)
                        self:updateColorPicker(colorpicker, name_)
                    end
                )
            end
        end
        ...
        local callback = function(value)
            if callback then
                callback(
                    value,
                    function(name_)
                        self:updateSlider(slider, name_)
                    end
                )
            end
        end
                ...
                function()
                    if callback then
                        callback(
                            value,
                            function(name_)
                                self:updateDropdown(dropdown, name_)
                            end
                        )
                    end
